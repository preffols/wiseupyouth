...
<nav class="navbar fixed-top navbar-expand-sm navbar-dark" style="background-color:rgba(0,0,0,0.5)">
            <div class="container">
                    <a href="index.php" class="navbar-brand" style="font-family: 'Delius Swash Caps'">Shop Nice Things with Wise Up Youth</a>
            ...
            <div class="modal-body">
              <form action="login_script.php" method="post">
                ...
                <div class="form-check">
                    ...
                    <label for="checkbox" class="form-check-label">Check Us out</label>
                </div>
